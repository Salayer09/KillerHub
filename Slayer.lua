...
local ColorMurderer = Color3.fromRGB(172, 57, 57)   
local ColorSheriff  = Color3.fromRGB(52, 115, 209)   
local ColorHero     = Color3.fromRGB(217, 179, 67)  
local ColorInnocent = Color3.fromRGB(67, 171, 96)   
